...
namespace FINAL_PROJECT_CAPSTONE_SERVER.Migrations
{
    ...
    [Migration("20240409161729_CambioNomeCampoImmagine_Tabella_Trainer")]
    partial class CambioNomeCampoImmagine_Tabella_Trainer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FINAL_PROJECT_CAPSTONE_SERVER.Models.Trainer", b =>
                {
                    ...
                    b.Property<string>("DescrizionePiano")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
